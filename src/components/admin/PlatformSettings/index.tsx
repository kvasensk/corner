  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.updatesWrap}>
        ...
        <ul>
          <li>
            В клиентском меню - Режим «Передвинуть»: можно перетаскивать разделы
          </li>
          <li>
            Иконка‑глаз у разделов в режиме «Передвинуть»: показ/скрытие раздела
            меню в один клик;
          </li>
          <li>
            Редактор «Типы и разделы»: добавление, переименование и удаление
            кастомных разделов; стандартные защищены; новые разделы видимы по
            умолчанию.
          </li>
          <li>
            Публичная страница: пустые/скрытые разделы не отображаются; у админа
            заголовок виден в режиме «Передвинуть».
          </li>
          <li>
            Цены для напитков: для соответствующих типов выводятся две колонки
            (0.2/0.3). типы задаются при создании и редактировании типа в
            Управление/настройки меню - Типы и разделы
          </li>
        </ul>
      </div>
